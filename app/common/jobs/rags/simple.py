...
def dummy_rag(project_id, resource_id):
    ...
    EventLogRows.create(resource.project.id, EventTypes.RESOURCE_PROCESSED, resource_id)


def rag_dispatcher(project_config: Config):
    return [dummy_rag]
